  ...
  * 简单来说 dp数组是记录的每一种方案 通过空间换时间 和cnt记忆化是两种不同的东西 [leetcode最长递增子序列](https://leetcode.cn/problems/longest-increasing-subsequence/)
  * [ACWING分组背包](https://www.acwing.com/problem/content/description/9/)
  *     for(int i = 0 ; i < groupNums ; i++){
  *        int[][] arr = group.get(i);
  *        for(int j = moeny ; i >= 0 ; j--){
