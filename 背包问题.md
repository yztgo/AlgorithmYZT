 ...
 *        int num = coins.length;
  ...
  *         int[][] dp = new int[num + 2][money + 1];
   ...
   ************************************** 回溯  ********************************************/
   [划分k个等和子集](https://leetcode.cn/problems/partition-to-k-equal-sum-subsets/description/)
   组合总和系列
   [负载均衡/分组](https://www.nowcoder.com/exam/test/94482103/detail?pid=63554020&examPageSource=Search)
   ...
   ************************************** 状态dp中的另类 乘积最大的子数组 ********************************************/
   ...
   后面的很多dp都可以按照背包问题的思路进行对应的方案数的统计 具体方案的收集
